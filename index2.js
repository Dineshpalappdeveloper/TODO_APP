...
let toDoCardContainer = document.querySelector(".toDoCardContainers");
let toDoCardContainer2 = document.querySelector(".toDoCardContainer2");
...
function createCard(id, cardTittle) {
  ...
  toDoCardContainer.appendChild(toDoCardContainerDiv);
  ...
  heading.addEventListener("click", () => {
    ...
    toDoCardContainer2.appendChild(toDoCardContainerDiv);
